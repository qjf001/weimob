...
<@main.tplSearchFrom />
<@main.tplTableGrid />
<script type="text/javascript" src="${rct.contextPath}/layui/tableIncubator.js"></script>
<#assign uri = rct.getRequestUri()>
<#include "${uri?substring(rct.contextPath?length,uri?length)}.ftl">
