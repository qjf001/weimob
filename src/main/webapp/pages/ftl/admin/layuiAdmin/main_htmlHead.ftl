...
<link rel="stylesheet" href="${rct.contextPath}/layui/css/global.css"/>
<script type="text/javascript" src="${rct.contextPath}/js/jquery-3.1.1.min.js"></script>
<script type="text/javascript" src="${rct.contextPath}/layui/layui.js"></script>
<script type="text/javascript" >
    ...
    var logout = function () {
        var $ = layui.jquery;
        $.ajax({
            url: "${rct.contextPath}/admin/logout",
    ...
    var changePwd = function () {
        ...
        layer.prompt({
            ...
            layer.close(index);
            $.post({
                url: "${rct.contextPath}/admin/resetPwd",
